	   ...
	   <?php include_once('inc/header.php'); ?>
		...
		<div class="pingenerator">
					...
					<form role="form">
						...
						<li><a data-type="30" href="#"  class="generatepin">30 days (1 mth)</a></li>
						<li><a data-type="60" href="#" class="generatepin">60 days (2 mths)</a></li>
						<li><a data-type="90" href="#" class="generatepin">90 days (3 mths)</a></li>
						<li><a data-type="180" href="#" class="generatepin">180 days (6 mths)</a></li>
										</ul>
									</div><!-- /btn-group -->
								</div><!-- /input-group -->
							</div><!-- /.col-lg-6 -->
